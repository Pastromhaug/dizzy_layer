...
def train_network(num_epochs, state_size, learning_rate, summary_name):
    train_writer = tf.train.SummaryWriter('./sequence/' + summary_name, sess.graph)
...
training_losses = train_network(num_epochs, state_size, 0.01, "dizzy_state_50_rots_4_lr_01")
training_losses = train_network(num_epochs, state_size, 0.001, "dizzy_state_50_rots_4_lr_001")
training_losses = train_network(num_epochs, state_size, 0.0001, "dizzy_state_50_rots_4_lr_0001")
